...
//       isotropically in the center-of-mass (fully flat phase space). Note that this is 
//       never the case in real life, due to the presence of non-zero spins and the 
//       V-A coupling of the W to SM fermions.
//    b) On-shell chargino production.
//    c) When the W ois off-shell, the mass distribution of the virtual W is 
//       not exactly what is neg=ing generated by Pythia but, since the difference
//       with the exact one is very small, the reweighiting procedure keeps that
